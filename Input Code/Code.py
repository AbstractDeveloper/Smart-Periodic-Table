# Input Code -- The user will have an option to select the element of his/her choice which is to be discussed with the whole class.
# Firebase Comuinication is done so that 2 Raspberry Pi's can communicate with each other.
